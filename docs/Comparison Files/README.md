...
| `customActivityReport.xlsx` | ✅ anonymized | Vanguard activity export. Quantities/amounts scaled; external bank reference ("To: SAMPLE BANK, NA") replaced with a generic label; AVUV added as a similar holding. |
