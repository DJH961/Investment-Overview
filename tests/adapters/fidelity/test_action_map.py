...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("LONG-TERM CAP GAIN FIDELITY SELECT SEMICONDUCTORS PORT (FSELX) (Cash)", "dividend_cash"),
        ("SHORT-TERM CAP GAIN FIDELITY SELECT SEMICONDUCTORS PORT (FSELX) (Cash)", "dividend_cash"),
        ("DISTRIBUTION SCHWAB STRATEGIC TR 1000 INDEX ETF", "dividend_cash"),
